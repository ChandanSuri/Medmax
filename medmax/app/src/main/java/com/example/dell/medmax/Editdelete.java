...
public class Editdelete extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        companyname.setText(ParseJSON.company[pos]);
        itemname.setText(ParseJSON.item[pos]);
        itemprice.setText(ParseJSON.price[pos]);
            ...
            public void onClick(View v) {
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
                    ...
                    protected Map<String, String> getParams() {
                        ...
                        params.put("companyName", ParseJSON.company[pos]);
                        params.put("itemName", ParseJSON.item[pos]);
                ...
                Intent intent = new Intent(Editdelete.this, FirstActivity.class);
    ...
    delete.setOnClickListener(new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            RequestQueue requestQueue = Volley.newRequestQueue(Editdelete.this);
            requestQueue.add(stringRequest);
            Intent intent1=new Intent(Editdelete.this,FirstActivity.class);
